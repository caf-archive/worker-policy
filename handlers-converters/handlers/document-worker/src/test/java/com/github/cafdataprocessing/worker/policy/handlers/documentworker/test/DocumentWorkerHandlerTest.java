 ...
 */
package com.github.cafdataprocessing.worker.policy.handlers.documentworker.test;
...
import com.github.cafdataprocessing.worker.policy.handlers.documentworker.DocumentWorkerHandler;
...
public class DocumentWorkerHandlerTest {

    private CorePolicyApplicationContext applicationContext;
    private DocumentWorkerHandler handler;
    ...
    public void SetupApplicationContext()
    {
        ...
        handler = new DocumentWorkerHandler();
    ...
    public void testWorkerHandler() throws IOException
    {
        ...
        Map<String, List<DocumentWorkerFieldValue>> taskFields = task.fields;
    ...
    {
        DocumentWorkerHandler localHandler = new DocumentWorkerHandler();
        PolicyType policyType = localHandler.getPolicyType();
        JsonNode policyDef = new ObjectMapper().readTree(this.getClass().getResource("/document-policy-definition.json"));
